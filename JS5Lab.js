...
console.log(
  `On July 20th ${person.year}, ${person.firstname} ${person.lastname} was the first person to set foot on Earth's moon.`
);
/*-------------------------------------------------------*/
 ...
 *
 * ↓ YOUR CODE HERE ↓ */
let myGreeting = new Greeting('Michael', 'Michigan');
myGreeting.hello();
...
/*
 * Using the provided code above:
 * Step 1: Create an new instance of Book called 'myBook' (see "new" keyword) done
 * Step 2: Use "Pride and Prejudice" and "Jane Austen" as the arguments DONE
 * Step 3: Using myBook, print just the title of the book to the console (see "this" keyword) DONE
 * Step 4: Now print the author of the book to the console DONE
 * Step 5: Invoke the describe method for the myBook instance. Surround with console.log to print to the console. DONE
 * Step 6: Create an new instance of Book called 'yourBook' with a title and author of your choosing dONE
...
let yourBook = new Book('Scythe', 'Neal Shusterman');
 ...
 *
 * ↓ YOUR CODE HERE ↓ */
let student = new Student('Jacky', 'stundent');
...
/*
 * DONE Step 1: Create a class called Movie with a constructor that takes in a title and director
 * DONE Step 2: Create a method inside of Movie called "describe" that returns the following sentence (make sure to fill in the title and director programmatically): "The movie [movie name here] was directed by [director name here]."
 * DONE Step 3: Create another class called List with a constructor that is an empty array called movies
 * DONE Step 4: Create a method called addMovie inside of List that will recieve a movie as a parameter and add it to the movies array
 * DONE Step 5: Create another method called displayMovies in the List class that will return all of the movie titles and directors using a for loop
 * DONE Step 6: Create two instances of Movie called movie1, use "Jurassic Park" and "Steven Spielberg" as it's arguments AND movie2, use "How the Grinch stole Christmas" and "Ron Howard" as it's arguments
 * DONE Step 7: Invoke the describe method on movie1, make sure it prints to the console
 * DONE Step 8: Invoke the desrcibe method on movie2, make sure it prints to the console
 * DONE Step 9: Create an instance of List called list and add movie1 and movie2 to the movies array
 * DONE Step 10: Display the movies information to the console, using the new instance list
 *
 * ↓ YOUR CODE HERE ↓ */
class Movie {
